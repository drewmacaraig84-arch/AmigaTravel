...
<body>
    ...
    <div class="footer">
        Amiga Gracia Travel Services &bull; Official Staff Performance &amp; Verification Audit Report &bull; Report Generated By: <strong>{{ $generatedBy ?? (auth()->user()?->name ?? 'Administrator') }}</strong> &bull; {{ ($generatedAt ?? now())->format('M d, Y h:i A') }} &bull; Page 1 of 1
    </div>
</body>
</html>
