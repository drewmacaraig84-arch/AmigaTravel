                                        ...
                                        <div class="absolute left-0 right-0 top-full mt-1 z-30 rounded-xl border border-slate-200 bg-white shadow-lg overflow-hidden">
                                            <div class="max-h-64 overflow-y-auto px-2 py-2 space-y-1">
                                                ...
                                                @foreach($modeOptions as $key => $label)
                                                    @if($key === 'airline')
                                                        <div class="w-full rounded-lg px-4 py-3 text-left text-slate-400 bg-slate-50/50 cursor-not-allowed select-none opacity-60" title="Airline ticketing is coming soon">
                                                            <div class="flex items-center justify-between gap-3">
                                                                <div class="flex items-center gap-2">
                                                                    <svg class="w-5 h-5 text-slate-400" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M6 12L3.269 3.126A59.768 59.768 0 0121.485 12 59.77 59.77 0 013.27 20.876L5.999 12zm0 0h7.5"/></svg>
                                                                    <span>{{ $label }}</span>
                                                                    <span class="inline-flex items-center rounded-full bg-amber-100 border border-amber-200 px-2 py-0.5 text-[10px] font-bold uppercase tracking-wider text-amber-800">Coming Soon</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    @else
