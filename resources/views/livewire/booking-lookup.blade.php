                            ...
                            <div class="space-y-4">
                                ...
                                @if($rebookingRequested && ! $rebookingPaid)
                                    <div class="rounded-2xl border border-blue-200 bg-blue-50/50 p-6 shadow-sm">
                                        ...
                                        @if($feedback)
                                            <div class="mb-4 rounded-xl border border-rose-300 bg-rose-50 p-4 text-sm text-rose-700">
                                                <div class="flex items-start">
                                                    <svg class="h-5 w-5 flex-shrink-0 text-rose-500 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z"></path></svg>
                                                    <div>
