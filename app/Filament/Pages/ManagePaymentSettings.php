                ...
                Section::make('Verification SLA Guarantee')
                    ...
                    ->schema([
                        \Filament\Forms\Components\Toggle::make('sla_voucher_enabled')
                            ...
                            ->helperText('When enabled, unverified bookings past the handling window receive an automatic voucher valid for 3 months.')
                            ->default(true),
                        ...
                        TextInput::make('sla_voucher_amount')
                            ...
                            ->helperText('Flat amount of the 3-month voucher issued to the client. Default: ₱500.00.')
                            ->numeric()
                            ->prefix('₱')
                            ->minValue(0)
                            ->required(),
